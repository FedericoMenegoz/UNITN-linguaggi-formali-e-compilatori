...
\newpage
\section*{Esercizio 8}
Costruiamo l'albero di derivazione e diamo un ordine per la valutazione delle regole semantiche.
  ...
  \begin{minipage}[t]{\linewidth}
    \begin{multicols}{2}
      ...
      \begin{enumerate}
        ...
        \item $C.b = B.t \quad \big \{T \rightarrow BC\big\}$
        \item $C_1.b = C.b \quad \big \{C \rightarrow [num]C_1\big\}$
        \item $C_1.b = C.b \quad \big \{C \rightarrow [num]C_1\big\}$
        \item $C_1.b = C.b \quad \big \{C \rightarrow [num]C_1\big\}$
        \item $C.t = C.b \quad \big \{C \rightarrow \epsilon\big\}$
        \item $C.t = array(num.lexval, C_1.t) \newline \big \{C \rightarrow [num]C_1\big\}$
        \item $C.t = array(num.lexval, C_1.t) \newline \big \{C \rightarrow [num]C_1\big\}$
        \item $C.t = array(num.lexval, C_1.t) \newline \big \{C \rightarrow [num]C_1\big\}$
        \item $T.t = C.t \quad \big \{T \rightarrow BC \big\}$
      \end{enumerate}
    \end{multicols}
  \end{minipage}
\end{center}
